...
export const articles: Article[] = [
  {
    id: 1,
    title: 'ERP系统日常操作指南',
    content: '<h2>概述</h2><p>本文档详细介绍ERP系统的日常操作流程...</p><h2>登录系统</h2><p>访问地址：erp.haike.com</p>',
    type: 'knowledge',
    systemId: 1,
    author: '张明华',
    authorId: 1,
